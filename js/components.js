...
(function() {
  ...
  var sidebarHTML = ''
    ...
    + '  <a href="' + base + '/research/index.html" class="nav-link' + isActive('research') + '">'
    + '    <span class="nav-icon">&#9733;</span>Research Hub</a>'
    + '  <a href="' + base + '/research/lme-concepts.html" class="nav-link' + isActive('research-lme-concepts') + '">'
    + '    <span class="nav-icon">&nbsp;</span>LME Foundations</a>'
    + '  <a href="' + base + '/research/novel-strategies.html" class="nav-link' + isActive('research-novel-strategies') + '">'
    + '    <span class="nav-icon">&nbsp;</span>Novel Strategies</a>'
    + '  <a href="' + base + '/research/case-studies.html" class="nav-link' + isActive('research-case-studies') + '">'
    + '    <span class="nav-icon">&nbsp;</span>Case Studies</a>'
    + '  <a href="' + base + '/research/countermeasures.html" class="nav-link' + isActive('research-countermeasures') + '">'
    + '    <span class="nav-icon">&nbsp;</span>Countermeasures</a>'
    + '  <a href="' + base + '/research/court-rulings.html" class="nav-link' + isActive('research-court-rulings') + '">'
    + '    <span class="nav-icon">&nbsp;</span>Court Rulings</a>'
    + '  <a href="' + base + '/research/lender-strategy.html" class="nav-link' + isActive('research-lender-strategy') + '">'
    + '    <span class="nav-icon">&nbsp;</span>Lender Strategy</a>'
    + '  <a href="' + base + '/research/odeon-analysis.html" class="nav-link' + isActive('research-odeon-analysis') + '">'
    + '    <span class="nav-icon">&nbsp;</span>Odeon Analysis</a>'
    + '  <a href="' + base + '/research/muvico-deep-dive.html" class="nav-link' + isActive('research-muvico-deep-dive') + '">'
    + '    <span class="nav-icon">&nbsp;</span>Muvico Deep Dive</a>'
    + '</div>'
